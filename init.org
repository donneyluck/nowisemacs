...
- [[#general-configuration][General Configuration]]
  ...
  - [[#undo][Undo]]
  - [[#automatically-insert-minibuffer][Automatically insert minibuffer]]
- [[#search][Search]]
  - [[#isearch][isearch]]
...
*** window
#+begin_src elisp
(transient-define-prefix +window()
  "Define leader-key map for window"
  [
   ["split"
    ("h" "split window vertical " split-window-vertically)
    ("v" "split window horizontal" split-window-horizontally)]
   ["move"
    ("w" "move windows" other-window)
    ("o" "delete other window" delete-other-windows)]
    ])
#+end_src
*** buffer
#+begin_src elisp
(transient-define-prefix +buffer()
...
*** helper
#+begin_src elisp
(transient-define-prefix +helper()
  "Define leader-key map for help functions"
  [["Helpful"
    ("f" "helpful-callable" helpful-callable)
...
*** search
#+begin_src elisp
(transient-define-prefix +search()
...
*** toggle
#+begin_src elisp
(transient-define-prefix +toggle()
  "Define leader-key map for toggle functions"
...
(setup dashboard
  (setq dashboard-items '((recents . 5)
        ...
        dashboard-startup-banner (concat nowis-config-useful-tools "anonymous.png")
...
(setup vundo
  (:bind "l" vundo-forward
         ...
         "k" vundo-previous))
#+end_src
** Automatically insert minibuffer
#+name: auto insert minibuffer
#+begin_src elisp
...
#+begin_src elisp
;; Files
(setq org-directory "~/Documents/emacs/01-orgmode/xnotes/gtd/")
  ...
  (:when-loaded
    (setq-default gptel-backend
                  (gptel-make-openai "chatanywhere"
                    ...
                    :key 'gptel-api-key
                    :stream t
                    :models '("gpt-3.5-turbo" "gpt-3.5-turbo-ca" "gpt-4o" "gpt-4o-ca")))
